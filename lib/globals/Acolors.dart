...
const Color kYellow = Color(0xffffe497);
const Color kGreen = Color(0xff056839);
const Color kGreenLight = Color(0x7B056839);
...
List<Color> textFieldGrad = [
  Color(0xffffe9ab),
  Color(0xfffdf5db),
];

List<Color> textFieldGrad2 = [
  Color(0xFF35976B),
  Color(0xFF84C5A7),
];